...
// const Input = forwardRef<HTMLInputElement, Props>(({ id, label, className }, ref) => {
//   return (
//     <div className="w-96 relative z-0">
//       <input type="text" id={id}
//         ref={ref}
//         className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-emerald-600 peer" placeholder=" " />
